export const v3 = {
    "productName": "GBP Readiness Check",
    ...
    "capabilities": [
        "Domain-specific workbench: Google Business Profile Handoff Desk",
        "Operational table: GBP readiness fields",
    ...
    "releaseChecklist": [
        ...
        "Listing Readiness reaches production threshold",
        "Owner Access Readiness is documented with evidence",
        "Photo/Review Completeness has no unresolved blocker",
        "Owner access request verified",
        "GBP handoff packet verified",
        "Listing fields CSV verified"
    ],
    "operations": [
