export const v1 = {
  "workbench": "Google Business Profile Handoff Desk",
  "table": "GBP readiness fields",
  "metrics": [
    "Listing Readiness",
  ...
  "sampleScenario": "Volta chapter uses GBP Readiness Check with Riverside Community Bakery to produce a release-ready v1.0 packet."
};
