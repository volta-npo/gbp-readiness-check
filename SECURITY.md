# Security Policy: GBP Readiness Check
...
- For this product's domain, review these gates before handoff: NAP fields required, Public claims need screenshot evidence, Ownership blocker prevents ready state.
